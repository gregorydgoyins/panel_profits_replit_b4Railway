...
CREATE TABLE "article_pages" (
	...
	"featured_image" text,
	"tags" text[],
	"category" text DEFAULT 'market_news',
	"view_count" integer DEFAULT 0,
	"featured" boolean DEFAULT false,
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now(),
	CONSTRAINT "article_pages_slug_unique" UNIQUE("slug")
);
--> statement-breakpoint
CREATE TABLE "asset_current_prices" (
	...
	"total_float" bigint,
	"shares_per_copy" integer DEFAULT 100,
	"census_distribution" jsonb,
	"scarcity_modifier" numeric(5, 4) DEFAULT '1.0000',
	"average_comic_value" numeric(15, 2),
	"updated_at" timestamp DEFAULT now(),
	"created_at" timestamp DEFAULT now()
);
--> statement-breakpoint
...
CREATE TABLE "asset_relationships" (
	...
	"target_asset_id" varchar NOT NULL,
	"relationship_type" text NOT NULL,
	"relationship_strength" numeric(3, 2) DEFAULT '0.50',
	"first_appearance" text,
	"first_appearance_comic_id" varchar,
	"key_issues" text[],
	"description" text,
	"metadata" jsonb,
	"created_at" timestamp DEFAULT now(),
...
CREATE TABLE "comic_covers" (
	...
	"collected_by" text DEFAULT 'bot',
	"significance_tier" integer DEFAULT 3,
	"significance_tags" text[],
	"key_character_appearances" text[],
	"first_appearance_of" text[],
	"featured_characters" text[],
	"grading_company" text,
	"grade" numeric(3, 1),
	"is_slabbed" boolean DEFAULT false,
	"record_sale_price" numeric(12, 2),
	"record_sale_date" timestamp,
...
--> statement-breakpoint
CREATE TABLE "creator_affiliations" (
	"id" varchar PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"creator_name" text NOT NULL,
	"publisher_code" text NOT NULL,
	"publisher_full_name" text NOT NULL,
...
CREATE TABLE "manga_characters" (
	...
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now(),
	CONSTRAINT "manga_characters_symbol_unique" UNIQUE("symbol")
);
--> statement-breakpoint
CREATE TABLE "manga_comics" (
	...
	"rating" numeric(3, 1),
	"total_float" integer,
	"base_market_value" numeric(15, 2),
	"current_price" numeric(10, 2),
	"total_market_value" numeric(15, 2),
	"regional_scalar" numeric(5, 2),
	"tier_multiplier" numeric(5, 2),
	"franchise_weight" numeric(5, 2),
	"appearance_modifier" numeric(5, 2),
	"data_source" text DEFAULT 'kaggle_manga_comprehensive',
	"source_metadata" jsonb,
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now(),
	CONSTRAINT "manga_comics_symbol_unique" UNIQUE("symbol")
);
--> statement-breakpoint
CREATE TABLE "manga_creators" (
	...
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now(),
	CONSTRAINT "manga_creators_symbol_unique" UNIQUE("symbol")
);
--> statement-breakpoint
CREATE TABLE "manga_series" (
	...
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now(),
	CONSTRAINT "manga_series_series_name_unique" UNIQUE("series_name")
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "marvel_character_appearances" (
	"id" varchar PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE "marvel_characters" (
	...
	"character_role" text,
	"franchise_tier" text NOT NULL,
	"franchise_importance" text,
	"description" text,
	"powers" text[],
	"abilities" text[],
	"weaknesses" text[],
	...
	"symbol" text NOT NULL,
	"base_market_value" numeric(12, 2),
	"current_price" numeric(12, 2),
	"price_change_percent" numeric(8, 4),
	"total_market_value" numeric(15, 2),
	"total_float" bigint,
	"relationship_recency_score" numeric(8, 4) DEFAULT '0.00',
	"last_media_mention" timestamp,
	"content_embedding" vector(1536),
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now(),
	CONSTRAINT "marvel_characters_symbol_unique" UNIQUE("symbol")
);
--> statement-breakpoint
CREATE TABLE "marvel_comics" (
	...
	"key_events" text[],
	"cover_image_url" text,
	"variant_covers" jsonb,
	"format" text,
	"page_count" integer,
	"price" text,
	"symbol" text NOT NULL,
	"franchise_tier" text,
	"series_prestige_multiplier" numeric(5, 2) DEFAULT '1.00',
	"base_market_value" numeric(12, 2),
	"current_price" numeric(12, 2),
	"price_change_percent" numeric(8, 4),
	"total_market_value" numeric(15, 2),
	...
	"is_key_issue" boolean DEFAULT false,
	"key_issue_type" text,
	"key_issue_description" text,
	"content_embedding" vector(1536),
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now(),
	CONSTRAINT "marvel_comics_symbol_unique" UNIQUE("symbol")
);
--> statement-breakpoint
CREATE TABLE "marvel_creator_credits" (
	"id" varchar PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"comic_id" varchar NOT NULL,
...
CREATE TABLE "marvel_creators" (
	...
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now(),
	CONSTRAINT "marvel_creators_symbol_unique" UNIQUE("symbol")
);
--> statement-breakpoint
CREATE TABLE "marvel_gadgets" (
	"id" varchar PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"symbol" text NOT NULL,
	"name" text NOT NULL,
	"description" text,
	"image_url" text,
	"gadget_category" text,
	"tier" integer NOT NULL,
	"creator" text,
	"creator_character_id" varchar,
	"power_source" text,
	"first_appearance" text,
	"first_appearance_comic_id" varchar,
	"associated_characters" text[],
	"associated_teams" text[],
	...
	"current_price" numeric(10, 2),
	"total_market_value" numeric(15, 2),
	"data_source" text DEFAULT 'marvel_curated',
	"metadata" jsonb,
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now(),
	CONSTRAINT "marvel_gadgets_symbol_unique" UNIQUE("symbol")
);
--> statement-breakpoint
CREATE TABLE "marvel_locations" (
	"id" varchar PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"symbol" text NOT NULL,
	"name" text NOT NULL,
	"description" text,
	...
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now(),
	CONSTRAINT "marvel_locations_symbol_unique" UNIQUE("symbol")
);
--> statement-breakpoint
CREATE TABLE "marvel_relationships" (
	"id" varchar PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"entity_type_1" text NOT NULL,
	"entity_id_1" varchar NOT NULL,
	"entity_type_2" text NOT NULL,
	"entity_id_2" varchar NOT NULL,
	"relationship_type" text,
	"relationship_strength" numeric(5, 2) DEFAULT '1.00',
	"relationship_recency" numeric(5, 2) DEFAULT '0.00',
	"last_refreshed" timestamp,
	"comic_appearances" integer DEFAULT 0,
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now()
);
--> statement-breakpoint
CREATE TABLE "marvel_series" (
	...
	"series_prestige_level" text,
	"critical_acclaim" text[],
	"cover_image_url" text,
	"symbol" text NOT NULL,
	"franchise_tier" text,
	"base_market_value" numeric(12, 2),
	...
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now(),
	CONSTRAINT "marvel_series_symbol_unique" UNIQUE("symbol")
);
--> statement-breakpoint
CREATE TABLE "marvel_teams" (
	"id" varchar PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"name" text NOT NULL,
	"aliases" text[],
	"description" text,
	...
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now(),
	CONSTRAINT "marvel_teams_symbol_unique" UNIQUE("symbol")
);
--> statement-breakpoint
...
CREATE TABLE "npc_traders" (
	...
	"leverage_preference" numeric(5, 2),
	"aggressiveness" numeric(5, 2),
	"intelligence" numeric(5, 2),
	"emotionality" numeric(5, 2),
	"adaptability" numeric(5, 2),
	"trades_per_day" integer,
	"min_time_between_trades_minutes" integer,
	...
	"is_active" boolean DEFAULT true,
	"last_trade_time" timestamp,
	"next_trade_time" timestamp,
	"paused_until" timestamp,
	"influence_on_market" numeric(5, 2),
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now()
);
--> statement-breakpoint
...
ALTER TABLE "asset_relationships" ADD CONSTRAINT "asset_relationships_source_asset_id_assets_id_fk" FOREIGN KEY ("source_asset_id") REFERENCES "public"."assets"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "asset_relationships" ADD CONSTRAINT "asset_relationships_target_asset_id_assets_id_fk" FOREIGN KEY ("target_asset_id") REFERENCES "public"."assets"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "comic_covers" ADD CONSTRAINT "comic_covers_verified_by_users_id_fk" FOREIGN KEY ("verified_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "marvel_character_appearances" ADD CONSTRAINT "marvel_character_appearances_comic_id_marvel_comics_id_fk" FOREIGN KEY ("comic_id") REFERENCES "public"."marvel_comics"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "marvel_character_appearances" ADD CONSTRAINT "marvel_character_appearances_character_id_marvel_characters_id_fk" FOREIGN KEY ("character_id") REFERENCES "public"."marvel_characters"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "marvel_creator_credits" ADD CONSTRAINT "marvel_creator_credits_comic_id_marvel_comics_id_fk" FOREIGN KEY ("comic_id") REFERENCES "public"."marvel_comics"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "marvel_creator_credits" ADD CONSTRAINT "marvel_creator_credits_creator_id_marvel_creators_id_fk" FOREIGN KEY ("creator_id") REFERENCES "public"."marvel_creators"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "price_history" ADD CONSTRAINT "price_history_asset_id_assets_id_fk" FOREIGN KEY ("asset_id") REFERENCES "public"."assets"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_asset_rel_source" ON "asset_relationships" USING btree ("source_asset_id");--> statement-breakpoint
CREATE INDEX "idx_asset_rel_target" ON "asset_relationships" USING btree ("target_asset_id");--> statement-breakpoint
CREATE INDEX "idx_asset_rel_type" ON "asset_relationships" USING btree ("relationship_type");--> statement-breakpoint
CREATE INDEX "idx_asset_rel_source_type" ON "asset_relationships" USING btree ("source_asset_id","relationship_type");--> statement-breakpoint
...
CREATE INDEX "idx_comic_covers_publisher" ON "comic_covers" USING btree ("publisher");--> statement-breakpoint
CREATE INDEX "idx_comic_covers_series" ON "comic_covers" USING btree ("series");--> statement-breakpoint
CREATE INDEX "idx_comic_covers_issue" ON "comic_covers" USING btree ("issue_number");--> statement-breakpoint
CREATE INDEX "idx_comic_covers_source_type" ON "comic_covers" USING btree ("source_type");--> statement-breakpoint
CREATE INDEX "idx_comic_covers_significance_tier" ON "comic_covers" USING btree ("significance_tier");--> statement-breakpoint
CREATE INDEX "idx_comic_covers_verification" ON "comic_covers" USING btree ("verification_status");--> statement-breakpoint
CREATE INDEX "idx_comic_covers_collected_at" ON "comic_covers" USING btree ("collected_at");--> statement-breakpoint
CREATE INDEX "idx_comic_covers_composite" ON "comic_covers" USING btree ("publisher","series","issue_number","variant","volume_year");--> statement-breakpoint
...
CREATE INDEX "idx_dc_comics_series_id" ON "dc_comics" USING btree ("series_id");--> statement-breakpoint
CREATE INDEX "idx_dc_comics_issue_number" ON "dc_comics" USING btree ("issue_number");--> statement-breakpoint
CREATE INDEX "idx_dc_comics_comic_name" ON "dc_comics" USING btree ("comic_name");--> statement-breakpoint
...
CREATE INDEX "idx_manga_characters_symbol" ON "manga_characters" USING btree ("symbol");--> statement-breakpoint
CREATE INDEX "idx_manga_characters_series" ON "manga_characters" USING btree ("series");--> statement-breakpoint
CREATE INDEX "idx_manga_comics_symbol" ON "manga_comics" USING btree ("symbol");--> statement-breakpoint
CREATE INDEX "idx_manga_comics_year" ON "manga_comics" USING btree ("year");--> statement-breakpoint
CREATE INDEX "idx_manga_comics_manga_type" ON "manga_comics" USING btree ("manga_type");--> statement-breakpoint
CREATE INDEX "idx_manga_creators_symbol" ON "manga_creators" USING btree ("symbol");--> statement-breakpoint
CREATE INDEX "idx_manga_creators_role" ON "manga_creators" USING btree ("role");--> statement-breakpoint
CREATE INDEX "idx_manga_series_name" ON "manga_series" USING btree ("series_name");--> statement-breakpoint
CREATE INDEX "idx_manga_series_status" ON "manga_series" USING btree ("status");--> statement-breakpoint
CREATE INDEX "idx_marvel_appearances_comic" ON "marvel_character_appearances" USING btree ("comic_id");--> statement-breakpoint
CREATE INDEX "idx_marvel_appearances_character" ON "marvel_character_appearances" USING btree ("character_id");--> statement-breakpoint
CREATE INDEX "idx_marvel_characters_symbol" ON "marvel_characters" USING btree ("symbol");--> statement-breakpoint
CREATE INDEX "idx_marvel_characters_franchise_tier" ON "marvel_characters" USING btree ("franchise_tier");--> statement-breakpoint
CREATE INDEX "idx_marvel_characters_character_type" ON "marvel_characters" USING btree ("character_type");--> statement-breakpoint
CREATE INDEX "idx_marvel_characters_name" ON "marvel_characters" USING btree ("name");--> statement-breakpoint
CREATE INDEX "idx_marvel_comics_series_id" ON "marvel_comics" USING btree ("series_id");--> statement-breakpoint
CREATE INDEX "idx_marvel_comics_symbol" ON "marvel_comics" USING btree ("symbol");--> statement-breakpoint
CREATE INDEX "idx_marvel_comics_franchise_tier" ON "marvel_comics" USING btree ("franchise_tier");--> statement-breakpoint
CREATE INDEX "idx_marvel_comics_key_issue" ON "marvel_comics" USING btree ("is_key_issue");--> statement-breakpoint
CREATE INDEX "idx_marvel_credits_comic" ON "marvel_creator_credits" USING btree ("comic_id");--> statement-breakpoint
CREATE INDEX "idx_marvel_credits_creator" ON "marvel_creator_credits" USING btree ("creator_id");--> statement-breakpoint
CREATE INDEX "idx_marvel_credits_role" ON "marvel_creator_credits" USING btree ("role");--> statement-breakpoint
CREATE INDEX "idx_marvel_creators_symbol" ON "marvel_creators" USING btree ("symbol");--> statement-breakpoint
CREATE INDEX "idx_marvel_creators_name" ON "marvel_creators" USING btree ("name");--> statement-breakpoint
CREATE INDEX "idx_marvel_creators_primary_role" ON "marvel_creators" USING btree ("primary_role");--> statement-breakpoint
CREATE INDEX "idx_marvel_gadgets_symbol" ON "marvel_gadgets" USING btree ("symbol");--> statement-breakpoint
CREATE INDEX "idx_marvel_gadgets_tier" ON "marvel_gadgets" USING btree ("tier");--> statement-breakpoint
CREATE INDEX "idx_marvel_gadgets_category" ON "marvel_gadgets" USING btree ("gadget_category");--> statement-breakpoint
CREATE INDEX "idx_marvel_locations_symbol" ON "marvel_locations" USING btree ("symbol");--> statement-breakpoint
CREATE INDEX "idx_marvel_locations_tier" ON "marvel_locations" USING btree ("tier");--> statement-breakpoint
CREATE INDEX "idx_marvel_locations_type" ON "marvel_locations" USING btree ("location_type");--> statement-breakpoint
CREATE INDEX "idx_marvel_relationships_entity1" ON "marvel_relationships" USING btree ("entity_id_1");--> statement-breakpoint
CREATE INDEX "idx_marvel_relationships_entity2" ON "marvel_relationships" USING btree ("entity_id_2");--> statement-breakpoint
CREATE INDEX "idx_marvel_relationships_type" ON "marvel_relationships" USING btree ("relationship_type");--> statement-breakpoint
CREATE INDEX "idx_marvel_series_symbol" ON "marvel_series" USING btree ("symbol");--> statement-breakpoint
CREATE INDEX "idx_marvel_series_name" ON "marvel_series" USING btree ("name");--> statement-breakpoint
CREATE INDEX "idx_marvel_teams_symbol" ON "marvel_teams" USING btree ("symbol");--> statement-breakpoint
CREATE INDEX "idx_marvel_teams_name" ON "marvel_teams" USING btree ("name");--> statement-breakpoint
...
CREATE INDEX "idx_other_comics_series_id" ON "other_comics" USING btree ("series_id");--> statement-breakpoint
CREATE INDEX "idx_other_comics_publisher" ON "other_comics" USING btree ("publisher");--> statement-breakpoint
CREATE INDEX "idx_other_comics_issue_number" ON "other_comics" USING btree ("issue_number");--> statement-breakpoint
CREATE INDEX "idx_other_comics_comic_name" ON "other_comics" USING btree ("comic_name");--> statement-breakpoint
CREATE INDEX "idx_price_history_asset_grade_date" ON "price_history" USING btree ("asset_id","grade","snapshot_date");--> statement-breakpoint
CREATE INDEX "idx_price_history_snapshot_date" ON "price_history" USING btree ("snapshot_date");--> statement-breakpoint
