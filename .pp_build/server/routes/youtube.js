...
const youtubeVideoService_1 = require("../services/youtubeVideoService");
const youtubeApiService_1 = require("../services/youtubeApiService");
const videoEmbeddingService_1 = require("../services/videoEmbeddingService");
const router = (0, express_1.Router)();
// Extract all videos from all channels using YouTube Data API v3
router.post('/extract', async (req, res) => {
    try {
        if (!youtubeApiService_1.youtubeApiService.isConfigured()) {
            // Fallback to RSS if no API key
            const result = await youtubeVideoService_1.youtubeVideoService.fetchAndStoreAllVideos();
            return res.json({
                success: true,
        ...
        const results = await youtubeApiService_1.youtubeApiService.fetchAllChannels();
        res.json({
            success: true,
...
router.get('/recent', async (req, res) => {
    try {
        ...
        const videos = await youtubeVideoService_1.youtubeVideoService.getRecentVideos(limit);
        res.json({
            success: true,
            count: videos.length,
            videos,
...
router.get('/channel/:channelName', async (req, res) => {
    try {
        ...
        const limit = parseInt(req.query.limit) || 50;
        const videos = await youtubeVideoService_1.youtubeVideoService.getVideosByChannel(channelName, limit);
        res.json({
            success: true,
            channel: channelName,
            count: videos.length,
...
router.get('/comicgirl19/xmen', async (req, res) => {
    try {
        const videos = await youtubeVideoService_1.youtubeVideoService.getComicGirl19XMenVideos();
        res.json({
            success: true,
            count: videos.length,
...
router.post('/comicgirl19/extract', async (req, res) => {
    try {
        ...
        const result = await youtubeApiService_1.youtubeApiService.fetchComicGirl19XMen();
        res.json({
            success: true,
...
router.get('/nerdsync/catalog', async (req, res) => {
    try {
        const videos = await youtubeVideoService_1.youtubeVideoService.getNerdSyncCatalog();
        res.json({
            success: true,
            count: videos.length,
...
router.post('/nerdsync/extract', async (req, res) => {
    try {
        ...
        const result = await youtubeApiService_1.youtubeApiService.fetchNerdSyncCatalog();
        res.json({
            success: true,
...
router.get('/search', async (req, res) => {
    try {
        ...
        const videos = await youtubeVideoService_1.youtubeVideoService.searchVideosByTags(tags, limit);
        res.json({
            success: true,
            tags,
            count: videos.length,
...
router.post('/embed/all', async (req, res) => {
    try {
        ...
        const result = await videoEmbeddingService_1.videoEmbeddingService.embedAllVideos();
        res.json({
            success: true,
...
router.get('/search/semantic', async (req, res) => {
    try {
        ...
        const results = await videoEmbeddingService_1.videoEmbeddingService.searchVideos(query, limit, filters);
        res.json({
            success: true,
            query,
...
router.get('/search/comicgirl19-xmen', async (req, res) => {
    try {
        const limit = parseInt(req.query.limit) || 50;
        const results = await videoEmbeddingService_1.videoEmbeddingService.searchComicGirl19XMen(limit);
        res.json({
            success: true,
...
router.get('/search/nerdsync', async (req, res) => {
    try {
        ...
        const results = await videoEmbeddingService_1.videoEmbeddingService.searchNerdSync(topic, limit);
        res.json({
            success: true,
            topic,
            count: results.length,
