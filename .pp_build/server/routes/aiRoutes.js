...
const aiMarketIntelligence_js_1 = require("../services/aiMarketIntelligence.js");
...
router.get('/predictions', async (req, res) => {
    ...
    try {
        ...
        const predictions = await aiMarketIntelligence_js_1.aiMarketIntelligence.generatePricePredictions(demoAssets);
...
router.get('/insights', async (req, res) => {
    ...
    try {
        ...
        const insights = await aiMarketIntelligence_js_1.aiMarketIntelligence.generateMarketInsights(demoAssets);
...
router.get('/challenges', async (req, res) => {
    ...
    try {
        ...
        const challenge = await aiMarketIntelligence_js_1.aiMarketIntelligence.createBeatTheAIChallenge(challengeAssets);
