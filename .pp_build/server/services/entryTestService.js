...
exports.scoringEngine = exports.PsychologicalScoringEngine = exports.testQuestions = exports.QuestionCategory = exports.HouseId = exports.PsychologicalDimension = void 0;
const crypto_1 = require("crypto");
// Psychological dimensions measured
var PsychologicalDimension;
(function (PsychologicalDimension) {
    PsychologicalDimension["ANALYTICAL"] = "analytical";
    PsychologicalDimension["AGGRESSIVE"] = "aggressive";
    PsychologicalDimension["STRATEGIC"] = "strategic";
    PsychologicalDimension["INNOVATIVE"] = "innovative";
    PsychologicalDimension["CONTRARIAN"] = "contrarian";
    PsychologicalDimension["QUANTITATIVE"] = "quantitative";
    PsychologicalDimension["DOMINANT"] = "dominant";
    PsychologicalDimension["PATIENT"] = "patient";
    PsychologicalDimension["ETHICAL"] = "ethical";
    PsychologicalDimension["COLLABORATIVE"] = "collaborative";
})(PsychologicalDimension || (exports.PsychologicalDimension = PsychologicalDimension = {}));
// House identifiers matching the Seven Houses
var HouseId;
(function (HouseId) {
    HouseId["SOLON"] = "solon";
    HouseId["VELOS_THORNE"] = "velos_thorne";
    HouseId["WINNOW_GREY"] = "winnow_grey";
    HouseId["NOVA_LUX"] = "nova_lux";
    HouseId["ECHO_FALLOW"] = "echo_fallow";
    HouseId["KYTHERA"] = "kythera";
    HouseId["THANATOS_GRIP"] = "thanatos_grip";
})(HouseId || (exports.HouseId = HouseId = {}));
// Test question categories
var QuestionCategory;
(function (QuestionCategory) {
    QuestionCategory["RISK_TOLERANCE"] = "risk_tolerance";
    QuestionCategory["MORAL_FLEXIBILITY"] = "moral_flexibility";
    QuestionCategory["LEADERSHIP"] = "leadership";
    QuestionCategory["LOYALTY_AMBITION"] = "loyalty_ambition";
    QuestionCategory["ENDS_MEANS"] = "ends_means";
    QuestionCategory["INFORMATION"] = "information";
    QuestionCategory["COMPETITION"] = "competition";
    QuestionCategory["TIME_HORIZON"] = "time_horizon";
...
class PsychologicalScoringEngine {
    ...
    calculateHouseAffinity(responses) {
        ...
        responses.forEach(response => {
            if (response.dimensionScores) {
                Object.entries(response.dimensionScores).forEach(([dim, score]) => {
                    dimensionScores[dim] = (dimensionScores[dim] || 0) + score;
                });
            }
            if (response.houseAffinities) {
                Object.entries(response.houseAffinities).forEach(([house, score]) => {
        ...
        return {
            ...
            consistencyScore,
            assignmentRationale: this.generateRationale(sortedHouses[0].house, dimensionScores),
    ...
    generateRationale(houseId, dimensions) {
...
exports.PsychologicalScoringEngine = PsychologicalScoringEngine;
exports.scoringEngine = new PsychologicalScoringEngine();
