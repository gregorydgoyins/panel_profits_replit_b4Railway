...
exports.goCollectService = void 0;
class GoCollectService {
    constructor() {
        this.baseUrl = 'https://api.gocollect.com/api';
        this.cache = new Map();
        this.cacheExpiry = 7200000; // 2 hours for census data
     ...
     */
    async getCensusDataByName(comicName) {
     ...
     */
    estimateCensusDistribution(era, totalCopies) {
     ...
     */
    calculateWeightedMarketCap(censusDistribution, pricesByGrade, sharesPerCopy = 100) {
     ...
     */
    async getMarketDataByIssue(comicName, issueNumber, grader) {
        if (!this.apiKey) {
     ...
     */
    async getTrendingGradedComics(limit = 50) {
        if (!this.apiKey) {
     ...
     */
    async getPriceHistory(comicName, issueNumber, grade, grader = 'CGC', days = 365) {
        if (!this.apiKey) {
...
exports.goCollectService = new GoCollectService();
