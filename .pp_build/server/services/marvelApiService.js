...
exports.MarvelApiService = void 0;
...
class MarvelApiService {
    ...
    getHighQualityImageUrl(thumbnail) {
    ...
    extractFeaturedCharacters(comic) {
        return comic.characters.items.map(char => char.name);
    }
}
exports.MarvelApiService = MarvelApiService;
