...
exports.pineconeMarketDataMigration = void 0;
...
class PineconeMarketDataMigrationService {
     ...
     */
    extractPriceFromAssetMetadata(asset) {
    ...
    async migrateMarketData() {
        ...
        try {
            ...
            const allAssets = await storage_1.storage.getAssets();
            ...
            for (const asset of pineconeAssets) {
                try {
                    ...
                    const existingMarketData = await storage_1.storage.getLatestMarketData(asset.symbol, '1d');
...
exports.pineconeMarketDataMigration = new PineconeMarketDataMigrationService();
