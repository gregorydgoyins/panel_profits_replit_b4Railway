...
exports.youtubeApiService = exports.YouTubeApiService = void 0;
...
class YouTubeApiService {
     ...
     */
    extractTags(title, description, tags = []) {
     ...
     */
    async fetchChannelVideos(channelId, channelName, maxResults) {
     ...
     */
    async fetchAndStoreChannel(channelId, channelName, maxVideos) {
     ...
     */
    async fetchComicGirl19XMen() {
        const result = await this.fetchAndStoreChannel('UCCyTmNW8vJdGKXjL76eSDxA', 'ComicGirl19'
     ...
     */
    async fetchNerdSyncCatalog() {
        const result = await this.fetchAndStoreChannel('UC3L_XqkuCG9m0HJWx8c2Z1A', 'NerdSync'
        // No maxVideos - fetch complete channel history
        );
        return {
            fetched: result.fetched,
