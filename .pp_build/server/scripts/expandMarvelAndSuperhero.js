...
const superheroApiExpansion_1 = require("../services/superheroApiExpansion");
async function main() {
    ...
    const superheroResults = await superheroApiExpansion_1.SuperheroApiExpansionService.expandAll();
    ...
    try {
        const marvelChars = await marvelExpansionService_1.marvelExpansionService.expandCharacters(0, 2000);
    ...
    try {
        const marvelComics = await marvelExpansionService_1.marvelExpansionService.expandComics(0, 1000);
    ...
    try {
        const marvelCreators = await marvelExpansionService_1.marvelExpansionService.expandCreators(0, 500);
