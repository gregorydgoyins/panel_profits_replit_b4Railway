...
exports.formatTickerSymbol = formatTickerSymbol;
/**
 ...
 */
function cleanAndAbbreviate(name, maxLength = 6) {
 ...
 */
function isProperTickerFormat(symbol) {
 ...
 */
function formatTickerSymbol(symbol, name) {
