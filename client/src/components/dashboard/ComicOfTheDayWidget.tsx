    ...
    <Card className="h-full !bg-[#1A1F2E] green-rimlight-hover" data-testid="widget-comic-of-the-day">
      ...
      <CardContent>
        ...
        <Link href={`/historical-significance/${comic.id}`} data-testid="link-historical-significance" className="block">
          <div className="bg-green-600 border border-green-700 rounded-lg p-4 green-rimlight-hover cursor-pointer overflow-visible">
        ...
        {comic.creators && comic.creators.length > 0 && (
          <div className="bg-green-600 border border-green-700 rounded-lg p-4 green-rimlight-hover overflow-visible">
            <h4 className="font-semibold text-foreground flex items-center gap-2 mb-2">
