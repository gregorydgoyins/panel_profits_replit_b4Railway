...
export function LandingPage() {
  ...
  const [videoSource, setVideoSource] = useState("/videos/pexels-nighttime.mp4");
  ...
  useEffect(() => {
    ...
    const updateVideoByTime = () => {
      ...
      setVideoSource(isDaytime ? "/videos/pexels-daytime.mp4" : "/videos/pexels-nighttime.mp4");
    };
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col relative overflow-hidden">
      {/* Full-frame looping video background - switches based on time of day */}
      <video
