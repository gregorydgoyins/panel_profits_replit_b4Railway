...
import { GlobalMarketClocks } from './GlobalMarketClocks';
...
export function DashboardHeader({ 
  ...
  return (
    <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 rounded-xl overflow-hidden mb-6">
      <div className="p-6">
      ...
      {/* Second Foundation Layer - Global Market Clocks */}
      <GlobalMarketClocks />
    </div>
  );
}