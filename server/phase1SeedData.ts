...
import type {
  InsertTradingFirm, InsertGlobalMarketHours, InsertInformationTier,
  InsertAssetFinancialMapping, InsertNewsArticle, InsertNpcTrader
} from '@shared/schema.js';

// Seven House Trading Firms Seed Data
export const sevenHouseTradingFirms: InsertTradingFirm[] = [
  {
    houseId: "hellenic",
...
export const globalMarketHours: InsertGlobalMarketHours[] = [
  {
    marketCode: "NYC",
...
export const informationTiers: InsertInformationTier[] = [
  {
    tierName: "Elite",
    tierLevel: 1,
    newsDelayMinutes: 0,
...
// Sample Asset Financial Mappings
export const sampleAssetMappings: InsertAssetFinancialMapping[] = [
  {
...
export const sampleNewsArticles: InsertNewsArticle[] = [
  {
...
export const sampleNpcTraders: InsertNpcTrader[] = [
  {
